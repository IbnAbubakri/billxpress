      ...
      <div className="bg-white dark:bg-dark-800 rounded-3xl shadow-2xl p-8 max-w-md w-full text-center">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">Your wallet has been funded. Redirecting...</p>
          </>
        )}
        {status === 'error' && (
          <>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">Please try again or contact support.</p>
            <button
