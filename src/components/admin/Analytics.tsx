...
const Analytics: React.FC = () => {
  ...
  const regionData = [
    { name: "Lagos", value: 35, color: colors.primary },
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4 gap-4">
          ...
          <div className="flex items-center space-x-2">
            <select
              ...
              className="px-3 py-2 bg-neutral-50 dark:bg-dark-800 border border-neutral-200 dark:border-dark-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
            >
