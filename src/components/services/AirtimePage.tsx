    ...
    <DashboardLayout user={user} onLogout={onLogout}>
      <div className="p-4">
        <div className="flex items-center mb-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 dark:text-neutral-100">Buy Airtime</h1>
        ...
        <div className="max-w-md mx-auto">
          {/* Phone Number Input */}
          <div className="mb-4">
            <label htmlFor="airtimePhone" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
              Phone Number
            </label>
            <input
              id="airtimePhone"
          ...
          <div className="mb-4">
            <label htmlFor="airtimeCustomAmount" className="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
              Select Amount
            </label>
